...
public class SynthesisTableScreen extends AbstractContainerScreen<SynthesisTableMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Osmiumsmagic.MOD_ID, "textures/gui/container/synthesis_table.png");

    public SynthesisTableScreen(SynthesisTableMenu p_97741_, Inventory p_97742_, Component p_97743_) {
