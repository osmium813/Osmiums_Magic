...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<SynthesisRecipe>> SYNTHESIS_SERIALIZER =
            SERIALIZER.register("synthesis", () -> SynthesisRecipe.Serializer.INSTANCE);
